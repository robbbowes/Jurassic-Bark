...
require('pry-byebug')
  ...
  pet1 = Pet.new({ 'name' => 'Douglas McKenzie', 'adoptable' => true, 'breed' => 'dog',
    'admission_date' => '2017-07-15', 'bairn_friendly' => true, 'picture' => '/douglas_mckenzie.jpg' })
  pet1.save

  pet2 = Pet.new({ 'name' => 'Gertrude', 'adoptable' => false, 'breed' => 'cat',
    'admission_date' => '2017-06-22', 'bairn_friendly' => true, 'picture' => '/gertrude.png' })
  pet2.save
  ...
  pet8 = Pet.new({ 'name' => 'Hest Hesten', 'adoptable' => true, 'breed' => 'horse',
    'admission_date' => '2017-05-22', 'bairn_friendly' => true, 'picture' => '/hest_hesten.png' })
  pet8.save

  pet9 = Pet.new({ 'name' => 'Longface Jones', 'adoptable' => true, 'breed' => 'horse',
    'admission_date' => '2017-08-22', 'bairn_friendly' => true, 'picture' => '/longface_jones.jpg' })
  pet9.save

  pet10 = Pet.new({ 'name' => 'Terry', 'adoptable' => true, 'breed' => 'bird',
    'admission_date' => '2017-05-25', 'bairn_friendly' => true, 'picture' => '/terry.jpg' })
  pet10.save

  pet11 = Pet.new({ 'name' => 'Marek', 'adoptable' => false, 'breed' => 'cat',
    'admission_date' => '2017-05-22', 'bairn_friendly' => true, 'picture' => '/marek.jpg' })
  pet11.save
